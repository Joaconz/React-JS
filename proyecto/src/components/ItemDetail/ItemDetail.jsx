...
const ItemDetail = ({ product }) => {
  ...
  const { addToCart, selectOptions, optionSelected } = cartContext;

  const onAdd = (cant) => {
    addToCart(product, cant, product.id);
  };

/*let sourceImg = product.image[optionSelected]
console.log(optionSelected)
console.log(product.image[optionSelected])*/
let sourceImg = false
