...
const Cart = () => {
  ...
  const { cart, removeItem, clearCart, totalPrice, form, setForm } =
    cartContext;
        ...
        <div className="mt-20 flex flex-col max-w-none p-6 space-y-4 sm:p-10 dark:text-gray-900">
          ...
          <div className="flex justify-end space-x-4">
            <Link to="/" className="no-underline">
              <button className="flex text-white bg-gray-400 border-0 py-2 px-6 focus:outline-none hover:bg-gray-500 rounded ml-7">
                Back to shop
              </button>
            </Link>

            <button
              className="flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded ml-7"
